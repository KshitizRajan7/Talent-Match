...
export default async function CandidateDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 space-y-8">
      {/* Header */}
      <header className="bg-white p-8 rounded-3xl shadow-lg border border-gray-200 space-y-3 flex flex-col md:flex-row md:justify-between md:items-center">
        <div className="space-y-2">
          ...
          <p className="text-gray-700">
            Job Types: {candidate.jobTypes.join(", ")}
          </p>
          <p className="text-gray-700">
            Location Preference: {candidate.locationPreference}
          </p>
          <p className="text-gray-700">
            Email:{" "}
            <a
          ...
          {candidate.links.linkedin && (
            <li>
              <a
                ...
                target="_blank"
                className="px-4 py-2 rounded bg-blue-50 text-blue-700 font-medium hover:bg-blue-100 transition"
              >
                LinkedIn
              </a>
            </li>
          ...
          {candidate.links.github && (
            <li>
              <a
                ...
                target="_blank"
                className="px-4 py-2 rounded bg-gray-50 text-gray-800 font-medium hover:bg-gray-100 transition"
              >
                GitHub
              </a>
            </li>
          ...
          {candidate.links.portfolio && (
            <li>
              <a
                ...
                target="_blank"
                className="px-4 py-2 rounded bg-green-50 text-green-700 font-medium hover:bg-green-100 transition"
              >
                Portfolio
              </a>
            </li>
